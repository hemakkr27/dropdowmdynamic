...
<div class="mycls">
		...
		<li class="flotlefty bgsuccess">SUBDIVISION</li><li class="flotrig bgsuccess">	<?php echo $fetch['SUBDIVISION']?>	</li>
		...
		<li class="flotlefty bglight">Parliament Consitituency</li><li class="flotrig bglight">Kurukshetra</li>	
		<li class="flotlefty bgsuccess">Assembly Consitituency</li><li class="flotrig bgsuccess">	<?php echo $fetch['ASSEMBLYCONST'];?></li>	
		<li class="flotlefty bglight">Vaterinary Hospital</li><li class="flotrig bglight">	<?php echo $fetch['VATHOSPITAL'];?></li>	
...
<div class="clearfix">
  ...
  <div class="row">
		<div class="col-md-12">	
    <ul class="newclstb">
		<li class="flotlefty bglight"><span class="bold">Total Area</span> <br>
					Acre Kanal Marle<br> (Hectare)</li>
		<li class="flotrig bglight"><span class=" "><?php echo $fetch['TotalArea']?></span> <br><br>	<br></li>
		<li class="flotlefty bgsuccess"><span class="bold">Cultivable</span> <br>
					Acre Kanal Marle<br> (Hectare)</li>
		<li class="flotrig bgsuccess"><span class=" "><?php echo $fetch['CULTIVATIVEAREA']?></span> <br><br>	<br></li>
		
		<li class="flotlefty bglight"><span class="bold">Non-Cultivable</span> <br>
					Acre Kanal Marle<br> (Hectare)</li>
		<li class="flotrig bglight"><span class=" "><?php echo $fetch['NONCULTIVATIVEAREA']?></span> <br><br>	<br></li>
		<li class="flotlefty bgsuccess">Population</li><li class="flotrig bgsuccess">	<?php echo $fetch['TOTAL'];?>	</li>
		<li class="flotlefty bglight">Male</li><li class="flotrig bglight">	<?php echo $fetch['MALE'];?></li>	
			<li class="flotlefty bgsuccess">Female</li><li class="flotrig bgsuccess">	<?php echo $fetch['FEMALE'];?>	</li>
  ...
  <div class="row">
    ...
    <ul class="newclstb">
		...
		<li class="flotlefty bglight">IAY Incentive-<br>Homestead Scheme</li><li class="flotrig bglight">	<span class="displinli"><a href="#" target="_blank" class="underline pdcls10">2010-11</a> <br> 
			...
			<li class="flotlefty bgsuccess">Non-Cultivable</li><li class="flotrig bgsuccess">	<span class="displinli"><a href="#" target="_blank" class="underline pdcls10">2010-11</a> <br> 
					 <a href="#" target="_blank"class="underline ">  2011-12</a> <br> 
					 <a href="#" target="_blank"class="underline ">  2011-12</a>
					 </span></li>	
