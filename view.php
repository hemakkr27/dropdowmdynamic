...
<li><h3 class="redcls"> VILLAGENAME : </h3><h3><?php echo $fetch['VILLAGENAME']?></h3></li>
		...
		<li> <p>GRAM SACHIV<span class=" displinli floatright padright_10"><?php echo $fetch['GRAMSACHIV'];?> </span></p></li>
		 ...
		 <div class="col-md-3">
		 <h3><img src="http://localhost/dynamic/sarpanch/<?php echo $fetch['NVCODE']?>.JPG" width="100px" height="100px"></h3></div>
		 </div>
...
<!--   srno: <label><?php //echo $fetch['srno'];?></label> -->
  ...
  <!--   <a class="pad_10" href="<?php //echo $fetch['GMAP'];?>" target="_blank">Google Map: </a> -->
    ...
    <h3> <div class="center pad_10" >Longitude & Latitude:  </div></h3>
